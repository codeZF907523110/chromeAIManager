...
export const COMMANDS = [
  // ==================== TABS (8) ====================
  {
    intent: "tabs_observe",
    description:
      "查询标签页列表。可用 query、domain 过滤，默认返回当前窗口所有标签",
    dangerous: false,
    slots: {
  ...
  },
  {
    intent: "tabs_move",
    description:
      "移动标签页位置。tabIds 为空移动当前标签，index 为目标位置(0-based)",
    dangerous: false,
    slots: {
  ...
  },
  {
    intent: "tabs_group",
    description:
      "创建或更新标签分组。tabIds 指定要分组的标签，title 和 color 用于更新组属性",
    dangerous: false,
    slots: {
      ...
      groupName: { type: "string", optional: true, description: "分组名称（与 title 同义，支持别名）" },
      color: { type: "string", optional: true, description: "分组颜色（blue/cyan/green/grey/orange/pink/purple/red/yellow）" },
    },
    swIntent: "tabs_group",
  },
  {
  ...
  // ==================== BOOKMARKS (7) ====================
  {
    ...
    description:
      "观察完整书签树结构，返回节点 id/title/type/parentId/index/path/url/childCount",
    dangerous: false,
    slots: {
  ...
  },
  {
    ...
    description:
      "创建书签或文件夹。nodeType=folder|bookmark, parentId 指定父节点",
    dangerous: false,
    slots: {
  ...
  },
  {
    ...
    slots: {
      ...
      setting: {
        type: "string",
        description:
          "权限类型：popups/camera/javascript/images/notifications 等",
      },
  ...
  // ==================== BATCH (1) ====================
  {
    intent: "batch",
    description:
      "批量执行多个工具调用，一次性返回所有结果。适合同类操作的合并执行",
    dangerous: false,
    slots: {
      calls: {
        type: "array",
  ...
  },
  {
    intent: "set_theme",
    description:
      "设置主题模式（light/dark/device）或主题颜色（blue/gray/pink等或#RRGGBB）",
    dangerous: false,
    aiHidden: true,
    slots: {
      mode: {
