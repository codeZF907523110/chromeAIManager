...
declare const chrome: {
  runtime: {
    ...
    onMessage: {
      addListener(callback: (msg: any, sender: any, sendResponse: (response: any) => void) => boolean | void): void;
      removeListener(callback: (msg: any, sender: any, sendResponse: (response: any) => void) => boolean | void): void;
    };
    onInstalled: {
